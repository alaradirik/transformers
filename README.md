...
1. **[EfficientFormerV2](https://huggingface.co/docs/transformers/main/model_doc/efficientformerv2)** (from Snap Research) released with the paper [Rethinking Vision Transformers for MobileNet Size and Speed](https://arxiv.org/abs/2212.08059) by Yanyu Li, Ju Hu, Yang Wen, Georgios Evangelidis, Kamyar Salahi, Yanzhi Wang, Sergey Tulyakov, Jian Ren.
